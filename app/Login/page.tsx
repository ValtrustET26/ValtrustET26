...
<>
  ...
  <div className="relative z-10 h-full flex flex-col md:flex-row">
    <div className="w-full md:w-1/2 h-full flex items-center justify-center px-6 sm:px-10 lg:px-24">
      <div className="w-full max-w-[400px] -mt-6">
        ...
        <div className="mb-7">
          <h2 className="block text-5xl font-light text-black leading-tight mb-2">
            Welcome Back
          </h2>
        ...
        <form className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full h-11 px-4 border border-gray-300 rounded-md outline-none focus:ring-2 focus:ring-[#4ea2ff]"
            />
          </div>
          {/* PASSWORD */}
          <div>
    ...
    <div className="hidden md:flex md:w-1/2 h-full items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white">
        <h1 className="text-6xl lg:text-7xl font-extrabold mb-8">Valtrust</h1>
        <p className="text-2xl text-blue-200">Glad to have you here!</p>
      </div>
    </div>
  </div>
</>
