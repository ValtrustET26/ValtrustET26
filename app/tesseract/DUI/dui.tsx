    ...
    <div style={{ padding: 20 }}>
      ...
      <div>
        ...
        <button type="submit">Confirm</button>
          ...
          <h2>Recomendation</h2>
          <p>Use a clear and well-lit photo Make sure the image is not blurry and all information is easy to read.</p>
          <p>Capture both sides of the ID Upload photos of the front and back to show all the details.</p>
